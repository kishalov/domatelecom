...
export function CtaPromoSection() {
	...
	return (
		<section className="w-full bg-background py-10 sm:py-12 lg:py-16">
			<div className="mx-auto flex max-w-[1360px] flex-col gap-4 px-4 sm:gap-5 sm:px-6 lg:flex-row lg:items-stretch lg:gap-6 lg:px-0">
				<Card className="flex-1 bg-primary text-primary-foreground overflow-hidden p-0 h-fit lg:h-auto">
					<CardContent className="flex h-full flex-col p-0 sm:flex-row">
						<div className="flex flex-col justify-center gap-3 px-5 pt-6 sm:gap-4 sm:px-8 sm:py-8 lg:pl-12">
						...
						<div className="ml-auto flex items-end justify-center px-4 pb-4 pt-2 sm:px-0 sm:pb-0 sm:pt-0">
							<img
								src="/cta-cat.png"
								alt=""
								className="h-auto w-full max-w-[220px] object-contain sm:max-w-[240px] lg:h-full lg:max-w-none lg:w-auto lg:object-cover"
							/>
						</div>
					</CardContent>
				</Card>
