...
export default function EndScrollSection() {
	...
	return (
		<section className="w-full bg-secondary pt-32 pb-16 sm:pt-40 sm:pb-20 lg:pt-60 lg:pb-24">
			<div className="relative mx-auto flex max-w-[1360px] flex-col items-center px-4 sm:px-6 lg:px-0">
