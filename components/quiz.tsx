	...
	const slides: Slide[] = [
		{
			...
			right: (
				<Image
					src="/quiz-1.svg"
					alt="Помощь в выборе тарифов на домашний интернет и тв от ДомаТелеком"
					width={500}
					height={500}
    ...
    right: (
...
},
		{
			...
			right: (
				<Image
					src="/quiz-2.svg"
					alt="Помощь в выборе оборудования для интернета и тв от ДомаТелеком"
					width={500}
					height={500}
					className="absolute bottom-0 right-0 w-[500px] sm:w-[280px] md:-right-6 md:w-fit"
				/>
		...
		},
		{
			...
			right: (
				<Image
					src="/quiz-3.svg"
					alt="Провайдеры-партнеры ДомаТелеком"
					width={500}
					height={500}
