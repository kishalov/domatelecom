...
export function ArticlesSection() {
	return (
		<section className="w-full bg-secondary py-10 sm:py-14 lg:py-20">
			<div className="mx-auto flex max-w-[1360px] flex-col gap-6 px-4 sm:gap-8 sm:px-6 lg:gap-10 lg:px-0">
				{articles.map((a) => (
					<div key={a.id} className="relative flex w-full flex-col lg:flex-row">
						
						<div className="relative h-[200px] w-full overflow-hidden rounded-t-2xl bg-white sm:h-[260px] lg:h-auto lg:w-[630px] lg:rounded-l-3xl lg:rounded-tr-none lg:rounded-br-none">
							<Image
								src={a.img}
								alt={a.title}
								fill
						...
						<Card className="relative w-full p-5 sm:p-6 lg:-ml-12 lg:grid lg:grid-cols-2 lg:items-end lg:p-6">
